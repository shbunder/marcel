...
- If the user hasn't set up iCloud credentials, tell them they need to add ICLOUD_APPLE_ID and ICLOUD_APP_PASSWORD to their credentials file. The password must be an app-specific password generated at appleid.apple.com.
