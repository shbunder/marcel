...
Instead of dumping all memory into the system prompt, this module scans
frontmatter headers and asks a fast model (Haiku) to pick the most relevant
files for the current query.  Only selected files are loaded in full.
