...
When the user asks Marcel to improve, extend, or fix itself — switch to developer mode and follow the instructions in CLAUDE.md. Confirm with the user before making any code changes.
